      ...
      <div class="">
        <form method="POST">
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock" style="color:#15B9D9"></i></span>
            ...
            <!-- <span style="margin-top:-5px; margin-left:310px;"><i id="toggler"class="far fa-eye"></i></span> -->
          </div>
          ...
          <a class="ghost" href="index.php">Already have an account? login</a>
